...
def slider_changed(event):
    ...
    try:
        ...
        data["setting-info"][0]["allocated_ram"] = flt_s1
        data["allocated_ram"] = flt_s1
    except NameError:
        pass
...
def save_ram():
    ...
    data["setting-info"][0]["allocated_ram"] = allocated_ram_selected
    data["allocated_ram"] = allocated_ram_selected
