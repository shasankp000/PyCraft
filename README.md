...
# Pycraft 1.04-beta-1 release

  > Fixed issue of cracked login in Fabric. Players using cracked mode now have a permanent UUID generated by the launcher.
  >
  > Added a bit of readability by changing GUI colors(I haven't got a good palette still working on colors).
  >
